...
const Hero = () => {
  return (
    <section className="min-h-screen flex items-center justify-center relative">
      ...
      {/* 1. Hero Content: Shifted up an exact 20px more (-top-[72px]) on mobile */}
      <header className="max-w-4xl mx-auto w-full relative -top-[72px] md:top-0">
        ...
        {/* --- MOBILE ONLY: Statically placed hanging bar under the buttons --- */}
        <div className="md:hidden w-full flex justify-end mt-[84px] pb-8">
          <Reveal cascade className="flex flex-row-reverse items-center">
            ...
            <div className="ml-5">
              <a href="#" className="block text-text-muted hover:text-accent active:text-accent hover:-translate-y-1 active:-translate-y-1 transition-all duration-[250ms] ease-[cubic-bezier(0.645,0.045,0.355,1)]">
            ...
            <div className="ml-5">
              <a href="mailto:your-email@example.com" className="block text-text-muted hover:text-accent active:text-accent hover:-translate-y-1 active:-translate-y-1 transition-all duration-[250ms] ease-[cubic-bezier(0.645,0.045,0.355,1)]">
